...
This paper presents the design, implementation and evaluation of Giza - a strongly consistent, versioned object store that encodes and store objects across global data centers. Giza separates each GET and PUT operation into the data and meta-data path, each of which is built on top of existing cloud storage systems. 
