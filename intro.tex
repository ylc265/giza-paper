...
\comment{Complementary to today's cloud storage offerings, that store customer data within single data center, across multiple availability zones within a region, or even multiple geographically distributed data centers,}
