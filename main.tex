...
\newcommand{\name}{Giza\xspace}
\newcommand{\deployment}{11 DCs across 3 continents\xspace}
\newcommand{\dc}{DC}
\newcommand{\Dc}{DC}
\newcommand{\dcs}{DCs}
\newcommand{\Dcs}{DCs}
...
% \newcommand{\new}[1]{{\color{red} #1}}
%\newcommand{\key}[1]{{\color{blue} key sentence: #1}}
...
\newcommand{\AUTHORS}{Yu Lin Chen, Shuai Mu, Jinyang Li, Cheng Huang, Jin Li, Aaron Ogus, Douglas Phillips}
...
\newcommand{\TITLE}{Giza: Erasure Coding Objects across Global Data Centers}
...
\ifthenelse{\equal{\PAGENUMBERS}{yes}}{%
  \usepackage[nohead,
            left=1in,right=1in,top=1.0in,
            footskip=0.5in,bottom=1in,     % Room for page numbers
            columnsep=0.33in
            ]{geometry}
}{%
\usepackage[noheadfoot,left=0.75in,right=0.75in,top=1.0in,
...
%%  is below figure)
\usepackage[font=bf,aboveskip=5pt]{caption} % SPACE
...
%\titlespacing{\subsection}{0pt}{5pt}{3pt}      % SPACE
...
\author{{\large Yu Lin Chen$^\star$$^\dag$, Shuai Mu$^\star$, Jinyang Li$^\star$, Cheng Huang$^\dag$, Jin Li$^\dag$, Aaron Ogus$^\dag$, Douglas Phillips$^\dag$}\\
\textit{$^\star$New York University, $^\dag$Microsoft Corporation}
}%\\
%{\em Affiliations}}
